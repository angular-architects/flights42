import { AgentSubscriber, randomUUID } from '@ag-ui/client';
...
// Deliberately without HTTP: this demo talks to the agent in-process, so the
// focus stays on the AG-UI messages. How the very same agent is reached over
// HTTP (server-sent events) is shown by the Mastra example in ai-demo.
