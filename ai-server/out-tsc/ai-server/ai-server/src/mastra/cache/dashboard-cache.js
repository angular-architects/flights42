...
export function computeDashboardRequestHash(messages) {
...
export async function dashboardCacheExists(hash) {
  try {
...
export async function readDashboardCache(hash) {
  try {
...
export async function writeDashboardCache(hash, spec) {
  const entry = { spec };
