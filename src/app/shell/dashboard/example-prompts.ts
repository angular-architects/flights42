export const examplePrompts = [
  `Build a flights analytics dashboard.
...
- The same 5 tiles for flights from Hamburg to Graz.`,

  `Build my personal travel dashboard.

Include the following tiles:
- A boarding-pass tile (TicketWidget) for my next two upcoming booked flights.
...
- List with weather forecast for the destinations of all booked flights.`,
];
